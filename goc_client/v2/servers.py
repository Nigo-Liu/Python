...
class Servers():
    ...
    def get_detail(self, server_id):
        service_url = "/v2/servers/%d/"
        service_url = service_url % (server_id)
        return self.req_get(url=service_url)

    def get_assets_reports(self, begin_time=None, end_time=None,
                           group_id=None, user_id=None, site_id=None):
        service_url = "/v2/servers/reports/assets/"
    ...
    def get_statistics_reports(self, begin_time=None, end_time=None,
                               group_id=None, user_id=None, site_id=None):
        service_url = "/v2/servers/reports/statistics/"
        params = {'group_id': group_id, 'user_id': user_id, 'site_id': site_id}
        if begin_time:
            params.update({'begin_time': begin_time})
        if end_time:
