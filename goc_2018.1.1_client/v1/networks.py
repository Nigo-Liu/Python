...
class Networks():
    ...
    def create_ip(self, network_id, ip):
        service_url = "/v1/k8snetwork/%s/ip/" % network_id
        data = {"ip": ip}
        return self.req_post(url=service_url,
                             data=data)

    def delete_ip(self, network_id, ip_id):
        service_url = "/v1/k8snetwork/%(network_id)s/ip/%(ip_id)s/"
    ...
    def list_networks(self, group_id=None):
        service_url = "/v1/networks/"
        if group_id is None:
            service_url = "/v1/networks/"
        else:
            service_url = "/v1/networks/?group=%s" % group_id
        return self.req_get(url=service_url)
    ...
    def delete_network(self, network_id):
        service_url = "/v1/networks/%(network_id)s/"
