...
class Users():
    ...
    def get(self, user_id):
        ...
        return self.req_get(service_url)

    def associate(self, platform_name, group_id, user_id, role_name):
        service_url = "/v2/%s/projects/%s/users/%s/" % (
            platform_name, group_id, user_id)
        data = {'role': role_name}
        return self.req_post(url=service_url,
                             data=data)
