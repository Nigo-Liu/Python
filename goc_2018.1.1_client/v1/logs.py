...
class Logs():
    ...
    def list_logfiles_by_server(self, server_id, user_id=None):
        service_url = "/v1/logs/?server_id=%s"
    ...
    def get_logs(self, log_id, begin_time=None, end_time=None,
        ...
        service_url = "/v1/logs/%(log_id)s/content/"
    ...
    def delete_keyword(self, keyword_id):
        service_url = "/v1/logs/keywords/%(keyword_id)s/"
